...
| Spec ID   | 文档                                                          | 类型           | 优先级 |
| :-------- | :------------------------------------------------------------ | :------------- | :----: |
| SPEC-1001 | [RAG 深度集成](./specs/sprint10/SPEC-1001-rag-integration.md) | Integration    |   P1   |
| SPEC-1002 | [QA 质量硬化](./specs/sprint10/SPEC-1002-qa-hardening.md)     | QA             |   P0   |
| SPEC-1003 | [架构标准化](./specs/sprint10/SPEC-1003-standardization.md)   | Refactor       |   P1   |
| SPEC-1004 | [性能与安全](./specs/sprint10/SPEC-1004-perf-security.md)     | Infrastructure |   P2   |
...
| 8.7  | 知识库深度数据集成 (RAG)   | Integration |   P1   | ⬜ (S10) |
...
| :--- | :---------------- | :------- | :----: | :---: | :----------------------------- |
| 5.4  | 安全强化          | SPEC-504 |   P3   |   🚫   | 开发环境无需，生产环境另行处理 |
| B.1  | 暗黑模式切换      | -        |   P2   |   🚫   | 已支持三种模式，按钮非必需     |
| B.2  | Run Mode 轻量渲染 | -        |   P2   |   🚫   | 当前性能可接受，ROI不足        |
